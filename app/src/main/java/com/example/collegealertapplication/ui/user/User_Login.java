    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        not_signed.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent myIntent=new Intent(User_Login.this, User_SignUp.class);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            // Admin login failed
                            Toast.makeText(User_Login.this, "Login failed. Please check your credentials"+ task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
        ...
        firebaseAuth.sendPasswordResetEmail(email)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void avoid) {
                        ...
                        Utils.toast(User_Login.this, "Reset Link Sent To Your Email.");
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressBar.setVisibility(View.GONE);
                        Utils.toast(User_Login.this, "Error! Reset Link is Not Sent" + e.getMessage());
                    }
                });
    }
}
