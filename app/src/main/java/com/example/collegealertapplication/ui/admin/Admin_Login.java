...
import com.example.collegealertapplication.utils.Utils;
...
public class Admin_Login extends AppCompatActivity {
    //    public static class Adminlog_in extends AppCompatActivity {

    private EditText emailEditText, passwordEditText;
    private CheckBox showPasswordCheckbox;
    private FirebaseAuth firebaseAuth;
    TextView not_signed,forgotPasswordTv;
    Button LogIn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        not_signed.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent myIntent=new Intent(Admin_Login.this, Admin_SignUp.class);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent myIntent=new Intent(Admin_Login.this, AdminPage.class);
                            startActivity(myIntent);
                        } else {
                            // Admin login failed
                            Toast.makeText(Admin_Login.this, "Login failed. Please check your credentials"+ task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
        ...
        firebaseAuth.sendPasswordResetEmail(email)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void avoid) {
                        ...
                        Utils.toast(Admin_Login.this, "Reset Link Sent To Your Email.");
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressBar.setVisibility(View.GONE);
                        Utils.toast(Admin_Login.this, "Error! Reset Link is Not Sent" + e.getMessage());
                    }
                });
    }
}
